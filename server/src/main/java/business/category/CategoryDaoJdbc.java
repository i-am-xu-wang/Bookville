...
public class CategoryDaoJdbc implements CategoryDao {
    ...
    @Override public List<Category> findAll() {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException(
                "Encountered a problem finding all categories", e);
        }
        return categories;
    }


    @Override public Category findByCategoryId(long categoryId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException(
                "Encountered a problem finding category " + categoryId, e);
        }
        return category;
    }
    ...
    @Override public Category findByName(String name) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            PreparedStatement statement = connection
                .prepareStatement(FIND_BY_NAME_SQL)) {
            ...
            throw new BookstoreQueryDbException(
                "Encountered a problem finding category " + name, e);
        }
        return category;
    }
