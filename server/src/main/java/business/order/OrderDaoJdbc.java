...
public class OrderDaoJdbc implements OrderDao {
    ...
    private static final String CREATE_ORDER_SQL =
        "INSERT INTO customer_order (amount, confirmation_number, customer_id) " + "VALUES (?, ?, ?)";

    private static final String FIND_ALL_SQL =
        "SELECT customer_order_id, customer_id, amount, date_created, confirmation_number " + "FROM customer_order";

    private static final String FIND_BY_CUSTOMER_ID_SQL =
        "SELECT customer_order_id, customer_id, amount, date_created, confirmation_number " + "FROM customer_order WHERE customer_id = ?";

    private static final String FIND_BY_CUSTOMER_ORDER_ID_SQL =
        "SELECT customer_order_id, customer_id, amount, date_created, confirmation_number " + "FROM customer_order WHERE customer_order_id = ?";
    ...
    public long create(
        ...
        try (PreparedStatement statement = connection
            .prepareStatement(CREATE_ORDER_SQL,
            ...
            if (rs.next()) {
                ...
                throw new BookstoreUpdateDbException(
                    "Failed to retrieve customerOrderId auto-generated key");
            }
    ...
    @Override public List<Order> findAll() {
        ...
        try (Connection connection = getConnection();
            ...
            throw new BookstoreQueryDbException(
                "Encountered problem finding all orders", e);
        }
        return result;
    }


    @Override public Order findByOrderId(long orderId) {
        Order result = null;
        try (Connection connection = getConnection();
            PreparedStatement statement = connection
                .prepareStatement(FIND_BY_CUSTOMER_ORDER_ID_SQL)) {
            ...
            throw new BookstoreQueryDbException(
                "Encountered problem finding customer order id = " + orderId,
                e);
        }
        return result;
    }
    ...
    @Override public List<Order> findByCustomerId(long customerId) {
        ...
        try (Connection connection = getConnection();
            PreparedStatement statement = connection
                .prepareStatement(FIND_BY_CUSTOMER_ID_SQL)) {
            ...
            throw new BookstoreQueryDbException(
                "Encountered problem finding customer id = " + customerId, e);
        }
        return result;
    }
    ...
    private Order readOrder(ResultSet resultSet) throws SQLException {
        ...
        return new Order(orderId, amount, dateCreated, confirmationNumber,
            customerId);
    }
